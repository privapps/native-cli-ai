...
4. Update the primary public descriptions in `README.md`, `crates/cli/src/main.rs`, `docs/user/index.md`, and `docs/product/prd.md`, plus the architecture reference for the renamed context section.
